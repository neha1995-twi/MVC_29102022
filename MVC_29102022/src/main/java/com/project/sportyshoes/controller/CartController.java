...
import com.project.sportyshoes.repostary.PurchaseRepository;
import com.project.sportyshoes.repostary.UserRepository;
...
public class CartController {
	...
	@Autowired
	PurchaseRepostary purchaseRepostary;
	...
	public String orderConfirmation(Model model) {
		...
		User user = userRepostory.findUserByEmail(currentPrincipalName).get();
		...
		purchaseRepostory.saveAll(purchaseList);
